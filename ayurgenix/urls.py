...
urlpatterns = [
    ...
    # 🧠 AI Ayurvedic response endpoint
    path('api/ayurgenix/', views.ai_response_view, name='ayurgenix-api'),
]

urlpatterns += [
    path('accounts/login/', views.login_view, name='account_login'),  # Or use auth_views.LoginView.as_view()
]
